# Generated by Django 4.2.20 on 2025-04-18 07:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=100, verbose_name='客户名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_number', models.CharField(db_index=True, max_length=100, verbose_name='型号')),
                ('barcode', models.CharField(blank=True, max_length=50, unique=True, verbose_name='条形码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expired_date', models.DateField(blank=True, null=True, verbose_name='失效日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audit_status', models.CharField(choices=[('PENDING', '待审核'), ('APPROVED', '已审核'), ('REJECTED', '已驳回')], default='PENDING', max_length=10, verbose_name='审核状态')),
                ('audit_time', models.DateTimeField(blank=True, null=True, verbose_name='审核时间')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('auditor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='审核人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('batch_number', models.CharField(max_length=50, verbose_name='批号')),
                ('change_type', models.CharField(choices=[('IN', '入库'), ('OUT', '出库')], max_length=3, verbose_name='变动类型')),
                ('quantity', models.IntegerField(verbose_name='变动数量')),
                ('document_number', models.CharField(blank=True, max_length=50, verbose_name='单据编号')),
                ('notes', models.TextField(blank=True, verbose_name='备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, max_length=100, verbose_name='存储位置')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration_date', models.DateField(blank=True, null=True, verbose_name='有效期至')),
